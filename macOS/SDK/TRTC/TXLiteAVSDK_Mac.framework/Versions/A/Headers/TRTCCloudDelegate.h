 ...
 * 自定义视频预处理回调
 */
#pragma mark - TRTCVideoPostProcessDelegate
@protocol TRTCVideoPostProcessDelegate <NSObject>
/**
 * 自定义预处理纹理id回调
 * @param frame  返回给用户处理的 自定义数据（目前只支持 纹理textureId）
 */
@optional
- (void) onVideoPostProcess:(TRTCVideoFrame * _Nonnull)frame;
