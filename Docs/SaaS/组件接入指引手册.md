...
[**Android组件接入流程跳转*](#web_location)

[**IOS组件接入流程跳转*](#iOS_location)

[**WEB组件接入流程跳转*](#Android_location)
...
```
tc-videochat://tclass/[company_id]/[class_id]?user_id=[user_id]&user_token=[user_token]&user_sig=[user_sig]
```
