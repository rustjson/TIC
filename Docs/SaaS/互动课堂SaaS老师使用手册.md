...
本文描述互动课堂SaaS组件使用方式，可以依照[官方文档](https://cloud.tencent.com/document/product/680/34356)的流程申请该组件
...
## 二、如何进行备课
在上课之前需要准备好上课里需要用到的课件(PPT、PDF、WORD或MP4文件)。
其中MP4文件需要放在本机。在课中直接打开播放给学生看。
而PPT、PDF、WORD文件建议是在上课前完成上传(PPT文件需要服务器现行转码)。
...
### 1、如何开始上课
在老师准备就绪，学生加入课堂后，老师可通过点击标题栏中的上课(g)开始上课
